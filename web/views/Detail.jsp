<%-- 
    Document   : Detail
    Created on : Jul 6, 2020, 5:26:27 AM
    Author     : altha
--%>
...
<html>
    <head>
        <jsp:include page = "layouts/head.jsp">
            <jsp:param name="title" value="The Details"></jsp:param>
        </jsp:include>
    </head>
    <body>
                ...
                <div class="col-md-8 p-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="text-uppercase font-weight-bold">CSGO, game yang terkenal di seluruh dunia?</h3>
                                </div>
                                <div class="col-md-6">
                                    <p class="text-muted">Ditulis oleh: M Althaf Malfieri</p>
                                </div>
                                <div class="col-md-6 text-right">
                                    <p class="text-muted">Senin, 6 Juli 2020</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 text-center">
                            <img src="https://s.blanja.com/picspace/352/109920/1280.720_29ea9edc9b5e43abbf2ec4752e592070.jpg" width="100%">
                            <p class="text-muted pt-2">CSGO</p>
                        </div>
